...
const Hero: React.FC = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative pt-40 pb-20 md:pt-60 md:pb-40 overflow-hidden bg-background min-h-screen flex flex-col justify-center items-center transition-colors duration-300"
    >
      ...
      <div
        ref={textRef}
        className="container mx-auto px-4 relative z-10 text-center will-change-transform"
      >
        ...
        <div className="hero-text-element max-w-xl mx-auto text-muted-foreground text-lg md:text-xl leading-relaxed mb-12 relative">
          <p>
            We design and build intelligent software systems that automate
            operations, reduce cost, and unlock growth.
          </p>
          <p className="mt-4 text-sm opacity-80">
            From AI integration to scalable SaaS platforms, we engineer systems
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <div className="hero-button">
            <Button
              size="lg"
              className="min-w-[200px] uppercase tracking-widest text-xs font-bold"
            >
              Start a Project
            </Button>
          </div>
        ...
        <div className="absolute right-[5%] top-[25%] md:right-[10%] md:top-[35%] animate-float hidden xl:block opacity-0 hero-button">
          <a
            href="#contact"
            className="w-24 h-24 rounded-none bg-foreground text-background font-bold text-[10px] uppercase tracking-widest flex items-center justify-center hover:scale-110 transition-transform duration-300 shadow-[0_0_30px_rgba(0,0,0,0.1)] dark:shadow-[0_0_30px_rgba(255,255,255,0.3)] text-center leading-tight"
          >
            Let&apos;s
            <br />
            Talk
