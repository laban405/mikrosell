      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((t) => (
            <div
              key={t.id}
              className="bg-card border border-border p-10 relative group hover:border-foreground/20 transition-colors"
            >
              ...
              <div className="flex items-center gap-4">
                <Image
                  ...
                  width={40}
                  height={40}
                  className="w-10 h-10 rounded-none object-cover grayscale group-hover:grayscale-0 transition-all"
                />
                <div>
                  <h4 className="text-foreground text-xs font-bold uppercase tracking-widest">
                    {t.author}
                  </h4>
