  ...
  return (
    <MaxWidthWrapper className="max-w-3xl mx-auto px-8 mb-40">
      <AnimationContainer delay={0.1} className="w-full">
        ...
        <p className="mt-4">
          At <strong>Mikrosell</strong>, we are committed to protecting your
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          information. Please contact us at support@mikrosell.com to make this
          request.
        </p>
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          please contact us at support@mikrosell.com.
        </p>
