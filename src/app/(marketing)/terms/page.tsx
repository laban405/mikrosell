  ...
  return (
    <MaxWidthWrapper className="max-w-3xl mx-auto px-8 mb-40">
      <AnimationContainer delay={0.1} className="w-full">
        ...
        <p className="mt-4">
          Welcome to Mikrosell. These terms and conditions outline the rules and
          regulations for the use of Mikrosell&apos;s website and services.
        </p>

        <h2 className="text-xl font-medium mt-8">Acceptance of Terms</h2>

        <p className="mt-8 text-muted-foreground">
          By accessing and using Mikrosell, you accept and agree to be bound by
        ...
        <p className="mt-8 text-muted-foreground">
          Mikrosell reserves the right to modify these terms at any time. We
        ...
        <p className="mt-8">
          To use Mikrosell, you must be at least 18 years old and capable of
        ...
        <div className="mt-8">
          You agree not to use Mikrosell for any unlawful or prohibited
        ...
        <h3 className="text-lg mt-8">Content Ownership</h3>
        <p className="mt-8 text-muted-foreground">
          All content provided on the Mikrosell platform, including text,
          graphics, logos, and software, is the property of Mikrosell or its
          content suppliers and is protected by intellectual property laws. You
          may not reuse content without proper authorization.
        </p>

        <h3 className="text-lg mt-8">User-Generated Content</h3>
        <p className="mt-8 text-muted-foreground">
          You retain ownership of any content you create or upload to Mikrosell
          Hub. By submitting content, you grant Mikrosell a non-exclusive,
        ...
        <h2 className="text-xl font-medium mt-12">Termination of Services</h2>
        <p className="mt-8 text-muted-foreground">
          Mikrosell reserves the right to suspend or terminate your account at
        ...
        <p className="mt-8 text-muted-foreground">
          Mikrosell is provided on an &quot;as is&quot; and &quot;as
        ...
        <p className="mt-8 text-muted-foreground">
          In no event shall Mikrosell be liable for any indirect, incidental,
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          Conditions, please contact us at support@mikrosell.com.
        </p>

        <p className="mt-8 font-medium">
          By using Mikrosell, you acknowledge that you have read, understood,
